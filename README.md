...
npm install && npm run check     # typecheck + 271 tests + build + consumability fixture
```
...
**Implementation complete through the pre-integration tier; not yet released.** Current contract is **SPEC v3.6**; package version is `0.1.0-dev.0`.

- All five §19 milestones implemented. 271 tests green across 31 files, plus two env-gated profiles (`SOAK=1`, `FRESH_SEEDS=n`).
...
- Amendment rationale records, newest first: [v3.8 candidates](docs/proposals-v3.8.md) (proposed — host-surface gaps found by reading an embedder's glue) · [v3.7 candidates](docs/proposals-v3.7.md) (proposed, not ratified) · [v3.5/v3.6](docs/proposals-v3.5.md) (P1–P28, integration-surfaced) · [v3.4](docs/proposals-v3.4.md) (surfaced by failing P7 runs) · [v3.3](docs/proposals-v3.3.md) (vector/harness work)
